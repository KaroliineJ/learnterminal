...
write('\x1B[0;48m'); write('Hello world'); write('\x1B[0;0m'); write('\n');
...
write('\x1B[0;98m'); write('Hello world'); write('\x1B[0;0m'); write('\n');
write('\x1B[0;99m'); write('Hello world'); write('\x1B[0;0m'); write('\n');
...
write('\x1B[0;108m'); write('Hello world'); write('\x1B[0;0m'); write('\n');
write('\x1B[0;109m'); write('Hello world'); write('\x1B[0;0m'); write('\n');
...
for(let i=0; i<256; i++){
    write(`\x1B[48;2;${i};0;0m`); write('');  write('\x1B[1;0m');
}